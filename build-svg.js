...
const todayDay = new Intl.DateTimeFormat('en-US', { weekday: 'long', timeZone: 'Asia/Karachi' }).format(
  today
)

const psTime = formatDistance(new Date(2022, 12, 16), today, {
  addSuffix: false,
})

// Today's weather
const locationKey = '259633'
